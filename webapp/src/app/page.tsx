  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[40vh]">
      <div className="bg-white/80 dark:bg-zinc-900/80 rounded-xl shadow-xl p-10 w-full max-w-2xl mb-8 border border-zinc-200 dark:border-zinc-800">
        ...
        <p className="text-lg mb-8 text-zinc-700 dark:text-zinc-200">
          Digital consulting & development for businesses. <br />
          Web, native, APIs, automation, SEO, marketing, and more.<br />
